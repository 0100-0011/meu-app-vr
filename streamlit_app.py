...
def consolidar_bases(dataframes):
    ...
    if 'DIAS_UTEIS' in dataframes:
        ...
        if 'SINDICADO' in dias_uteis_df.columns:
            ...
            dias_uteis_df['Sindicato'] = None  # evita erro futuramente

        # Verifica existência das colunas necessárias antes de unir
    ...
    if uploaded_files:
        ...
        if st.button("Gerar VR Mensal com LangChain + Perplexity"):
            ...
            if pplx_api_key:
                ...
                st.warning("Por favor, insira a Chave API Perplexity para prosseguir.")
